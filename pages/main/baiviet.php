...
?>
<h3 style="margin-left: 15px;">Tin Tức: <span
        style="text-align: center;text-tramform: uppercase;"><?php echo $row_bv_title['tenbaiviet'] ?> </span></h3>
<ul class="baiviet">
    <?php 
                   while($row_bv = mysqli_fetch_array($query_bv_all)){
                   ?>
    <li>
        <h2 style="text-align: center;"><?php echo $row_bv['tenbaiviet'] ?></h2>
