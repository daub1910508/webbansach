...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark  " style="width: 100%; ">
    <a class="navbar-brand" href="index.php"><img src="./images/logo1.png" style="width: 45px;  border-radius: 0px" ;
            alt=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <?php
                ...
                ?>
            <li class="nav-item"><a class="nav-link" href="index.php?dangxuat=1">Đăng xuất:<?php if(isset($_SESSION['dangky'])){
        echo '<span style="color: red;">'.$_SESSION['dangky'].'</span>';
    } ?></a></li>

            <li class="nav-item">
                <a class="nav-link" href=" index.php?quanly= lichsudonhang">Lịch sử đơn hàng</a>
            </li>
            <?php
                    }else{
                ?>
...
<!-- <div class="menu">
    <ul class="list_menu">
        ...
        <?php
               ...
               ?>
        <li class="nav-item"><a href="index.php?quanly=giohang">Giỏ hàng</a></li>

        <?php
                    if(isset($_SESSION['dangky'])){
                        
                ?>
        <li><a href="index.php?dangxuat=1">Đăng xuất:<?php if(isset($_SESSION['dangky'])){
        echo '<span style="color: red;">'.$_SESSION['dangky'].'</span>';
    } ?></a></li>
