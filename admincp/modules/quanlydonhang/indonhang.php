...
$pdf->Write(10,'                                                  WEBSITE BÁN SÁCH HOMEBOOK TRỰC TUYẾN
                                                 Welcome HomeBook Kiến Thức Là Sức Mạnh
Đơn hàng của bạn bao gồm:');
$pdf->Ln(10);

$width_cell=array(8,30,150,25,30,40);
...
$pdf->Write(10,'Cảm Ơn Quý Khách Đã Mua Hàng Của Chúng Tôi ^_^.
Mọi thất mắc xin liên hệ số điện thoại: 0945275090');
$pdf->Ln(10);
